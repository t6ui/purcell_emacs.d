...
(when (maybe-require-package 'company)
  ...
  (maybe-require-package 'company-statistics))
...
In that case, insert the number."
  ...
  ;; see comments in citre-capf--make-collection
  ;; These is a bug when set set completion-styles to substring, author set
  ;; citre-completion-at-point to exclusive function.
  ;; Due to that, it's necessary to place company-capf at the end of list
  ;; TODO:: use company-dabbrev in text mode
  ...
  (setq company-insertion-triggers '(92  41 46 44 59))
...
(with-eval-after-load 'ispell
  ...
  (let* ((dict (concat user-emacs-directory "misc/english-words.txt")))
