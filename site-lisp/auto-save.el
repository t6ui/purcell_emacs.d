...
;;; intainer: en Bin (redguardtoo) <chenbin.sh AT gmail DOT com>
;; pyright ( 2013 ~ 2014, Andy Stewart, all rights reserved.
;; eated: 2013-12-31 00:32:00
;; Version: 1.0
;; URL:
;; Keywords: autosave
;; mpatibility: GNU Emacs 23.0.60.1
;;
...
;; RANTABILITY or FITNESS FOR A PARTILAR PURPOSE.  See the
;; GNU General Public License for more details.

;; You should have received a copy of the GNU General Public License
;; along with this program; see the file PYING.  If not, write to
;; the Free Software Foundation, Inc., 51 Franklin Street, Fifth
;; Floor, Boston,  02110-1301, USA.
...
(defun auto-save-include-p (filename)
  "Return non-nil if FILENA should be included.
